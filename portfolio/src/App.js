...
import WeatherApp from './components/weather-finesse-app/src/App';
import StockSearchApp from './components/market-data-app/src/App';
      ...
      <div className="App">
          ...
          <div className="sections">
            ...
            <li><Link to="/portfolio/weather">Weather App</Link></li>
              ...
              />
            <Route path="/portfolio/stocksearch" element={<StockSearchApp />} />  
              <Section
